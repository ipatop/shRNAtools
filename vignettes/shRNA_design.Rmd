...
This package contains two functions that will generate a DataFrame or tab separated file with the original table with the shRNA oligo design appended. 

The input should be a tab sepparated table with circRNA or linear RNA splicing junction coordinates and gene names in the format: 
...
The following packages are required, here example of how to install it
