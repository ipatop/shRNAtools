...
This package contains two functions that will generate a DataFrame or tab separated file with the original table plus the shRNA oligo design appended. 
